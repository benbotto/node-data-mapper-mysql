...
require('insulin').factory('ndm_MySQLUpdate',
  ['ndm_Update', 'ndm_assert', 'ndm_ParameterList'],
  ndm_MySQLUpdateProducer);

function ndm_MySQLUpdateProducer(Update, assert, ParameterList) {
  /**
   * A Query that represents an UPDATE statement in MySQL.
   * @extends Update
   */
